    ...
    <div className="w-full h-screen max-[925px]:h-full flex max-[900px]:flex-col justify-center items-center    relative top-20">
      <div className="w-[50%] max-[925px]:w-full h-screen flex flex-col justify-center items-start flex-wrap pl-4 gap-y-10 ">
        ...
        <div className="w-72  h-20 flex justify-start items-center  gap-x-8">
          <a className="w-28 h-12 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-md text-sm px-5 py-2.5 text-center mr-2 mb-2" href="https://drive.google.com/file/d/1R2j0plrL3wjiIn2w2rcngYMZrZZVdIRn/view?usp=drive_link">
            Resume
          </a>
        ...
        <a className="w-72  h-12 flex justify-start items-center gap-x-2" href="mailto:redwantapu1234@gmail.com">
